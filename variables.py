...
data_sync = [
    ...
    {"customerId": 60430, "productId": 326, "pageSize": 5, "startIndex": 1}
]
...
data_price_infor = [
    {"customerNumber": '100', "price": 200, "number": 123456, "name": "A"},
    {"customerNumber": '200', "price": 100, "number": 789356, "name": "C"}
]
